import { MeshDescription, Edge, Face, Node } from '../models/MeshDescription';
...
export class MeshWorker {
    ...
    async init(seed: number) {
        this.random = new XorShift128(seed, seed, seed, seed);
    }
    ...
    async build(subdivisions: number, distortion: number) {
        ...
        this.mesh = new MeshDescription(this.nodes, this.edges, this.faces);
